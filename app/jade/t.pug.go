...
const (
	t__0 = `<!DOCTYPE html><html><head><link rel="stylesheet" href="./public/style/main.css"/><title>`
	t__1 = `</title></head><body><h1>Jade - template engine`
	t__2 = `</h1><div class="container text-accent">`
	t__3 = `<p>            Jade/Pug is a terse and simple templating language with a <strong>focus</strong> on performance and powerful features.</p><div class="class-test">            ok y</div><span class="i-ph-anchor-simple-thin"></span></div></body></html>`
